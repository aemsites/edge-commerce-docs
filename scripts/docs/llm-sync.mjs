...
async function main() {
  ...
  for (const file of mdFiles) {
    ...
    const userPrompt = [
      ...
      'Content between `<!-- GENERATED: ... -->` markers is auto-generated from the source schema and is the authoritative definition of those fields. Never edit inside those markers. Do NOT add prose or examples elsewhere that merely restate a generated table row (a field name, type, or one-line description) — the table already covers it. Only add narrative for semantics a table cannot express (e.g. how fields interact, parent/variant precedence, sequencing), and keep it to the minimum.',
